...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 15 nov. 2025 à 02:12
...
CREATE TABLE IF NOT EXISTS `cfg_devis` (
  ...
  KEY `cfg_devis_user_id_foreign` (`user_id`)
...
(4, 11, 7, 1, 1, 1, 1, NULL, 100, NULL, NULL, 47, NULL, 1, 3, 1761514545, 1763089457),
...
(50, 24, 1, 2, 1, 3, 1, NULL, 120, NULL, NULL, 100, 45, 1, 3, 1762773897, 1763077373),
...
(55, 17, 20, NULL, 1, NULL, 5, 11, 110, NULL, NULL, 80, NULL, 1, 1, 1762816417, 1762816417),
...
(58, 17, 35, 2, 2, 2, 2, NULL, 133, 134, NULL, 89, 60, 1, 1, 1762828348, 1762828348),
(59, 1, 13, 3, 4, 1, 1, 6, 210, 128, 220, 88, NULL, 1, 1, 1762828540, 1763070245),
(60, 20, 1, 2, 1, 1, 2, NULL, 123, NULL, NULL, 100, NULL, 1, 3, 1762987581, 1763070686),
(61, 1, 9, 3, 2, 2, 3, NULL, 125, 120, NULL, 98, 39, 1, 3, 1762987612, 1763069517),
(62, 25, 25, NULL, 6, NULL, 5, 14, NULL, NULL, NULL, 112, NULL, 1, 1, 1763077914, 1763077914),
(63, 1, 1, 2, 1, 3, 2, NULL, 114, NULL, NULL, 110, 56, 1, 1, 1763082517, 1763082517);
...
(1, 'Admin', 'squalbass27@gmail.com', '$2y$10$WGXIo0B.Y6fpJ0Na4RZRb.3ba0K1HIXYkWrmcZPCmnkrnzwl4Aeki', 27, 1761219976, 1763091550, 1763172732, 'dfgdsfgs3d32132sdfhg315sdfh51', NULL, NULL, NULL, NULL),
...
(24, 'testeur4', 'testeur4@testeur4.com', '$2y$10$ukWOW3VNEaFLwHTlGZcPJeTanUKtXO6yQRys09AGxoky79B2R24ea', 3, 1762710682, 1763089783, 1763091311, '', NULL, 1762763405, NULL, NULL),
(25, 'Rachid', 'rachid@example.com', '$2y$10$ZMGpzdki7zLHcJriFAIEmemKDPIxYtOEhTGFZ6x5Qvz6jsoCD9ui6', 3, 1763077748, 1763078048, 1763079101, '', NULL, 1763077819, NULL, NULL);
...
(51, 1, '23101d898267e3d5a37964fc9bb51c453ec7650fec5a4428f9205711357d91ce', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 1763091550, 1765683550);
...
--
-- Contraintes pour la table `cfg_devis`
--
ALTER TABLE `cfg_devis`
  ADD CONSTRAINT `fk_devis_ancrage` FOREIGN KEY (`ancrage_id`) REFERENCES `cfg_ancrages` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_devis_finition` FOREIGN KEY (`finition_id`) REFERENCES `cfg_finitions` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_devis_forme` FOREIGN KEY (`forme_id`) REFERENCES `cfg_formes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_devis_pose` FOREIGN KEY (`pose_id`) REFERENCES `cfg_poses` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_devis_status` FOREIGN KEY (`id_status`) REFERENCES `cfg_status` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_devis_type` FOREIGN KEY (`type_id`) REFERENCES `cfg_types` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_devis_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_devis_verre` FOREIGN KEY (`verre_id`) REFERENCES `cfg_verres` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Contraintes pour la table `cfg_types`
--
ALTER TABLE `cfg_types`
  ADD CONSTRAINT `fk_types_model` FOREIGN KEY (`model_id`) REFERENCES `cfg_models` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

--
-- Contraintes pour la table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_users_group` FOREIGN KEY (`user_group_id`) REFERENCES `user_groups` (`id_group`) ON DELETE RESTRICT ON UPDATE CASCADE;
