...
export default [
  {
    ...
    defaultPreview: imgPath + "previews/tole-inox/tole-inox/sol/tole-inox-droit-sol.png", // 🆕 image de base
    fields: [{
      id: "type",
      label: "Type",
      type: "choice",
      ...
      required: true,
      options: [
        { value: "tole-inox",      label: "Tôle inox",      image: imgPath + "types/tole-inox/tole-inox.png" },
        { value: "tole-inox-et-cables",      label: "Tôle inox et Câbles",      image: imgPath + "types/tole-inox/tole-inox-et-cables.png" },
        { value: "tole-inox-et-barres",      label: "Tôle inox et Barres",      image: imgPath + "types/tole-inox/tole-inox-et-barres.png" },
        { value: "tole-inox-muret",     label: "Tôle inox Muret",     image: imgPath + "types/tole-inox/tole-inox-muret.png" }
      ]
    },
    {
      id: "finition",
...
function buildPreviewPath(selection) {
  ...
  return `${imgPath}previews/tole-inox/${type}/${pose}/${type}-${forme}-${pose}.png`;
}
