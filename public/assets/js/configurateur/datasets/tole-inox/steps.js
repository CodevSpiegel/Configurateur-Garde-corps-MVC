...
export default [
  ...
  // --------------------------------------------------------------------------
  {
    ...
    defaultPreview: "assets/images/configurateur/previews/tole-inox/tole-inox/sol/tole-inox-droit-sol.webp", // 🆕 image de base
    fields: [{
      id: "type",
      label: "Type",
      type: "choice",
      ...
      required: true,
      options: [
        { id: 33, typeId: 33, value: "tole-inox",      label: "Tôle inox",      image: "assets/images/configurateur/types/tole-inox/tole-inox.webp" },
        { id: 34, typeId: 34, value: "tole-inox-et-cables",      label: "Tôle inox et Câbles",      image: "assets/images/configurateur/types/tole-inox/tole-inox-et-cables.webp" },
        { id: 35, typeId: 35, value: "tole-inox-et-barres",      label: "Tôle inox et Barres",      image: "assets/images/configurateur/types/tole-inox/tole-inox-et-barres.webp" },
        { id: 36, typeId: 36, value: "tole-inox-muret",     label: "Tôle inox Muret",     image: "assets/images/configurateur/types/tole-inox/tole-inox-muret.webp" }
      ]
    },
    {
      id: "finition",
